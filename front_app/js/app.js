...
define([
    ...
    function($, _, Backbone) {
        ...
        var app = {
            ...
            URL : "projects/nfe114/Dressin/",                      // Base application URL
            API : "http://127.0.0.1/projects/nfe114/Dressin/api",                   // Base API URL (used by models & collections)
        ...
        $.ajaxSetup({
            url: "http://127.0.0.1/projects/nfe114/Dressin/api/index.php",
            cache: false
